...
#define SEGY_H
/*
*** A few trace header byte locations, counting from 0.
*/
#define CDP 20
#define OFFSET 36
#define NS 114
...
typedef struct {	/* segy - trace identification header */
	...
	/* local assignments */
	int d1;	/* sample spacing for non-seismic data x- coord cdp */

	int f1;	/* first sample location for non-seismic data y coord cdp */

	int iline;	/*IN-LINE number  189-192*/

	int xline;	/* CROSS-Line number 193-196 */

	int ungpow;	/* Sht Point number */
